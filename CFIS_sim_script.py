...
# nohup python -u ./Lens_Modeling_Auto/CFIS_sim_script.py > fits_sim/results_uncertainty/output.log &
...
data_path = '/Users/markmaus/Desktop/Physics_EPFL/Specialization_Project/fits_sim'
results_path = '/Users/markmaus/Desktop/Physics_EPFL/Specialization_Project/fits_sim/results_uncertainty_2'

if not exists(results_path):
    os.mkdir(results_path)

#Folder names for data, psf, noise map, original image [TO DO BY USER]
im_path = data_path + '/image_data'
# im_path = data_path + '/simulations'
psf_path = data_path + '/PSF_data'
noise_path = data_path + '/original_image'
noise_type = 'EXPTIME'
band_list = ['r']
obj_name_location = 0
...
select_objects = ['77488','78438']  #Model all images
...
#             lens_info[i]['exposure_time'] = data_dict['noise_hdr'][i][0]['EXPTIME']
            lens_info[i]['exposure_time'] = data_dict['noise_hdr'][i]['EXPTIME']
...
#     exec(open('Lens_Modeling_Auto/initial_e1e2_joint_loose.py').read())
...
#     exec(open('Lens_Modeling_Auto/initial_fit_simple.py').read())
    ...
    if this_is_a_test:
        ...
        fitting_kwargs_list = [['PSO', {'sigma_scale': 1, 'n_particles': 300, 'n_iterations': 2000,'threadCount': numCores}]
                                ,['MCMC', {'n_burn': 150, 'n_run': 1000, 'walkerRatio': 10, 'sigma_scale': .05,'threadCount':numCores}]
                              ]
